...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="/template/css/smartadmin-production-plugins.min.css">
    ...
    <!-- page related CSS -->
    <link rel="stylesheet" type="text/css" media="screen" href="/template/css/lockscreen.min.css">
...
<div id="main" role="main">
    ...
    <form class="lockscreen" method="POST" action="{{ route('login.post') }}">
        {{ csrf_field() }}
        <div class="logo">
            <h1 class="semi-bold"><img src="/template/img/logo-o.png" alt="" /> {{ config('site.name') }}</h1>
        </div>
        <div>

            <div>
                <h1><i class="fa fa-user fa-3x text-muted air air-top-right hidden-mobile"></i> Login</h1>

                <div class="input-group">
                    <input class="form-control" name="email" type="password" placeholder="Password">
                ...
                <p class="no-margin margin-top-5">
                    Logged as someone else? <a href="#"> Click here</a>
                </p>
            </div>

        </div>
        <p class="font-xs margin-top-5">
            Copyright {{ config('site.name') }} {{ date('Y') }}.
        </p>
    </form>
